...
var Shuffle = _React2['default'].createClass({
  ...
  _getPositions: function _getPositions() {
    ...
    _React2['default'].Children.forEach(this.props.children, function (child) {
      var ref = child.key;
      var node = _React2['default'].findDOMNode(_this3.refs[ref]);
  ...
  _renderClonesInitially: function _renderClonesInitially() {
    var self = this;
    var cloneProps = _assign2['default']({}, self.props, {
    ...
    _React2['default'].render(_React2['default'].createElement(Clones, cloneProps), self._portalNode);
